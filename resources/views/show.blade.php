...
<div class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
        <div class="flex-none">
            <img src="/img/frozen2.jpg" alt="frozen2" class="w-64 lg:w-96">
        </div>
        <div class="md:ml-24">
            ...
            <p class="text-gray-300 mt-8">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa asperiores quis id facere recusandae aut consequatur, neque et dolorum totam aspernatur similique nihil ipsa eos dolore labore fugiat laborum temporibus.
            </p>
...
<div class="movie-cast border-b border-gray-800">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/frozen2.jpg" alt="actor1" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
